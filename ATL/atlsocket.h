...
public:
	...
	ADDRINFOT* GetAddrInfoList() const;
	ADDRINFOT* GetAddrInfo(_In_ int nIndex = 0) const;
...
inline ADDRINFOT* CSocketAddr::GetAddrInfoList() const
{
	return m_pAddrs;
}

inline ADDRINFOT* CSocketAddr::GetAddrInfo(_In_ int nIndex /* = 0 */) const
{
	if (!m_pAddrs)
		return NULL;
