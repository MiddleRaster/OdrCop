...
//////////////////////////////////////////////////////////////////////////////
// CSecurityDescriptor
class ATL_DEPRECATED("CSecurityDescriptor has been replaced by CSID") CSecurityDescriptor
{
public:
	CSecurityDescriptor();
	~CSecurityDescriptor();
...
inline CSecurityDescriptor::~CSecurityDescriptor()
{
	delete static_cast<PISECURITY_DESCRIPTOR>(m_pSD);
	free(m_pOwner);
	free(m_pGroup);
	free(m_pDACL);
	free(m_pSACL);
		...
		if (ppvObj != NULL)
		{
			*ppvObj = NULL;
			...
			else
			{
				...
				hRes = _pAtlAutoThreadModule->CreateInstance(reinterpret_cast<void*>(m_pfnCreateInstance), riid, ppvObj);
			}
		}
		return hRes;
	}
