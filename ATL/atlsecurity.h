...
{
	static_assert(sizeof(ACCESS_ALLOWED_ACE) == sizeof(ACCESS_DENIED_ACE), "ACCESS_ALLOWED_ACE and ACCESS_DENIED_ACE should have the same layout");
	static_assert(offsetof(ACCESS_ALLOWED_ACE, Header)==offsetof(ACCESS_DENIED_ACE, Header), "ACCESS_ALLOWED_ACE and ACCESS_DENIED_ACE should have the same layout");
	static_assert(offsetof(ACCESS_ALLOWED_ACE, Mask)==offsetof(ACCESS_DENIED_ACE, Mask), "ACCESS_ALLOWED_ACE and ACCESS_DENIED_ACE should have the same layout");
	static_assert(offsetof(ACCESS_ALLOWED_ACE, SidStart)==offsetof(ACCESS_DENIED_ACE, SidStart), "ACCESS_ALLOWED_ACE and ACCESS_DENIED_ACE should have the same layout");
...
{
	static_assert(sizeof(ACCESS_ALLOWED_OBJECT_ACE) == sizeof(ACCESS_DENIED_OBJECT_ACE), "ACCESS_ALLOWED_OBJECT_ACE and ACCESS_DENIED_OBJECT_ACE should have the same layout");
	static_assert(offsetof(ACCESS_ALLOWED_OBJECT_ACE, Header)==offsetof(ACCESS_DENIED_OBJECT_ACE, Header), "ACCESS_ALLOWED_OBJECT_ACE and ACCESS_DENIED_OBJECT_ACE should have the same layout");
	static_assert(offsetof(ACCESS_ALLOWED_OBJECT_ACE, Mask)==offsetof(ACCESS_DENIED_OBJECT_ACE, Mask), "ACCESS_ALLOWED_OBJECT_ACE and ACCESS_DENIED_OBJECT_ACE should have the same layout");
	static_assert(offsetof(ACCESS_ALLOWED_OBJECT_ACE, Flags)==offsetof(ACCESS_DENIED_OBJECT_ACE, Flags), "ACCESS_ALLOWED_OBJECT_ACE and ACCESS_DENIED_OBJECT_ACE should have the same layout");
	static_assert(offsetof(ACCESS_ALLOWED_OBJECT_ACE, ObjectType)==offsetof(ACCESS_DENIED_OBJECT_ACE, ObjectType), "ACCESS_ALLOWED_OBJECT_ACE and ACCESS_DENIED_OBJECT_ACE should have the same layout");
	static_assert(offsetof(ACCESS_ALLOWED_OBJECT_ACE, InheritedObjectType)==offsetof(ACCESS_DENIED_OBJECT_ACE, InheritedObjectType), "ACCESS_ALLOWED_OBJECT_ACE and ACCESS_DENIED_OBJECT_ACE should have the same layout");
	static_assert(offsetof(ACCESS_ALLOWED_OBJECT_ACE, SidStart)==offsetof(ACCESS_DENIED_OBJECT_ACE, SidStart), "ACCESS_ALLOWED_OBJECT_ACE and ACCESS_DENIED_OBJECT_ACE should have the same layout");
