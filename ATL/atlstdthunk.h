...
#if !defined(USE_ATL_THUNK2) && !defined(USE_ATL_THUNK1) && (defined(_M_IX86) || defined(_M_X64) || defined(_M_ARM64) || defined(_M_ARM64EC))
...
#pragma pack(pop)
#else
#error Only X86, X64, and ARM64 supported
#endif
...
public:
	...
	{
#ifdef USE_ATL_THUNK2
		return reinterpret_cast<void*>(AtlThunk_DataToCode(pThunk));
#else
